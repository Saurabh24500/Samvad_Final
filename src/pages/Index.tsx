...
const stats = [
  ...
  { value: '500+', label: 'Active Engineers' },
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-primary-foreground pt-20">
          <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-primary-foreground/80 max-w-2xl mx-auto leading-relaxed">
              CivicConnect empowers citizens to report local issues and enables authorities to resolve them efficiently. Together, we build better communities.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <div
                key={index}
                className="glass-card p-6 group hover:shadow-lg transition-all duration-500 hover:-translate-y-1 animate-slide-up"
                style={{ animationDelay: `${index * 100}ms` }}
              >
